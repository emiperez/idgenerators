...
/**
 *  <p>This {@linkplain IdGenerator} returns a String build by the Date and Time and, if there already
 *  was another id at the same time, a sequential number appended.
 *  
 *  <p>Example: {@code "2020-06-08T04:25:59-1"}
 */
